...
export function CardsEdit() {
    ...
    <EditOption type={'slide'}>
        ...
        <form className="add-slide-content">
            ...
            <textarea ref={answer} defaultValue={state.answer} className='input textarea' id='add-card-textarea add-slide-textarea' placeholder='Answer to the question'></textarea>
        </form>
        ...
        <button className="add-slide-btn primary-btn" onClick={() => {
                ...
                if(image.current!.src !== 'https://images.unsplash.com/photo-1458222960031-58c2a8f3ae50?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80%22') {
