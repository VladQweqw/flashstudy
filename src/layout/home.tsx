...
import heroImage2 from '../assets/images/hero-1.png'   
import heroImage3 from '../assets/images/hero-2.png'   
import heroImage4 from '../assets/images/hero-3.png'    
...
export default function Home() {
   ...
   useEffect(() => {
      ...
      if(heroIndex > heroImages.length - 2) {
         setHeroIndex(0) 
      }else if(heroIndex < 0) {
         setHeroIndex(heroImages.length - 1);
      }
   ...
   return(
    <div className="hero">
      ...
      <div className="hero-left">
         ...
         <h1 id='hero-dinamic-text'>Easy to manage</h1>
      ...
      <div className="hero-middle">
         ...
         <div className="hero-slideshow">
            ...
            <img src={heroImage1} alt="hero-slideshow-image-2" className="hero-slideshow-image" />
            <img src={heroImage1} alt="hero-slideshow-image-3" className="hero-slideshow-image" />
            <img src={heroImage1} alt="hero-slideshow-image-4" className="hero-slideshow-image" />
         </div>
      ...
      <svg className='hero-wave-svg' viewBox="0 0 1920 100" fill="none" xmlns="http://www.w3.org/2000/svg">
