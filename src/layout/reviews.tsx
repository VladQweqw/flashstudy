...
export default function Reviews() {
   ...
   return(
    <div className="reviews section-spacing">
        ...
        <path d="M203.537 168.5C260.324 22.5 13.1344 14 1.99976 0V528C46.5384 521.667 136.284 485.2 138.956 390C142.297 271 146.75 314.5 203.537 168.5Z" fill="#915643" fill-opacity="0.58"/>
        <path id='reviews-left-svg' d="M145.5 204C220.434 69.5751 9.54402 14 3.05176e-05 0V496.5C38.176 490.167 93.7092 499.2 95.9998 404C98.863 285 72.7533 334.5 145.5 204Z" fill="#915643" fill-opacity="0.58"/>
        </svg>
        ...
        <path d="M8.4626 359.5C-48.3242 505.5 198.865 514 210 528V0C165.461 6.33333 75.716 42.8 73.0436 138C69.7032 257 65.2494 213.5 8.4626 359.5Z" fill="#915643" fill-opacity="0.58"/>
        <path d="M66.5 324C-8.43427 458.425 202.456 514 212 528V31.5C173.824 37.8333 118.291 28.8 116 124C113.137 243 139.246 193.5 66.5 324Z" fill="#915643" fill-opacity="0.58"/>
        </svg>
    </div>
   )
}